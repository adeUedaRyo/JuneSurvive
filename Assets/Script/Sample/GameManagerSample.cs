...
{
    static private GameManagerSample _instance = new GameManagerSample();
    static public GameManagerSample Instance => _instance;
    private GameManagerSample() { }
    ...
    public void GetExperience(int exp)
    {
        ...
        //level up
        if (GameDateSample.LevelTable.Count > _level && _exp > GameDateSample.LevelTable[_level])
        {
            _level++;
